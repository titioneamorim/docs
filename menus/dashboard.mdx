---
title: 'Dashboard'
description: 'Dashboard de informações.'
---

# DASHBOARD

O dashboard registra suas atividades de atendimento dentro da plataforma.  
...
Relatório do que os clientes acharam do atendimento. Pode ser configurado com um bot para enviar a pesquisa automaticamente. A aba possui quatro itens:
